...
import com.bitget.openapi.service.BitgetNoAuthService;
...
public class BitgetApiFacade {
     ...
     * REST API Endpoint
     */
    public BgEndpoint v1() {
        return new BgEndpoint(apiClient);
    }
    public static BgNoAuthEndpoint noAuth(String baseUrl,Long timeout) {
        return new BgNoAuthEndpoint(baseUrl,timeout);
    }

    public BgEndpointV2 v2() {
        return new BgEndpointV2(apiClient);
    }
    ...
    public static class BgNoAuthEndpoint{
        ApiClient apiClient;
        public BgNoAuthEndpoint(String baseUrl,Long timeout) {
         ...
         */
        public BitgetService request() {
            return new BitgetNoAuthService(apiClient);
        }
    }

 ...
 */
public class BitStratThreadFactory implements ThreadFactory {
    ...
    public static BitStratThreadFactory forName(String name) {
        return new BitStratThreadFactory(name);
    }

    private BitStratThreadFactory(String name) {

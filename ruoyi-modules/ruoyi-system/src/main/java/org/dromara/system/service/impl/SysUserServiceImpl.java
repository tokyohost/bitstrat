...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    public boolean registerUser(SysUserBo user, String tenantId) {
        ...
        userRegisterEvent.setUserId(user.getUserId());
        SpringUtils.getApplicationContext().publishEvent(userRegisterEvent);
        return b;
    }
    ...
    @Override
    public BaseMapper getSysUserMapper() {
        return baseMapper;
    }

    @Override
    public int updateUserBalance(SysUserAddBalanceBo balanceBo) {

        return baseMapper.updateUserBalance(balanceBo);
    }

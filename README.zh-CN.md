...
| 交易所     | API 管理 | Websocket 支持     | 合约交易 | 现货交易 | 支持持仓模式     | 模拟盘支持|
|---------|--------|------------------|------|------|------------|----------|
| bitget  | 支持     | 支持 |  支持   | 暂未支持        | 单向持仓模式(合约) |支持(合约)| 
| okx     | 支持     | 支持 |  支持   | 暂未支持        | 双向持仓模式(合约)     | 支持(合约)| 
| binance | 支持     | 支持 |  暂未支持   | 暂未支持        | 双向持仓模式(合约)     | 暂未支持(合约)| 
| bybit   | 支持     | 支持 |  暂未支持   | 暂未支持        | 单向持仓模式(合约)     | 暂未支持(合约)| 
# 功能模块
| 功能      | 详情                              |
|---------|---------------------------------|

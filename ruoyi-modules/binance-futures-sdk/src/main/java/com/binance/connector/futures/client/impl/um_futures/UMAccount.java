...
public class UMAccount extends Account {
    ...
    /**
     * see also: <a href="https://developers.binance.com/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/Modify-Order">
     *     https://developers.binance.com/docs/zh-CN/derivatives/usds-margined-futures/trade/rest-api/Modify-Order</a>
     * @param parameters
     * @return
     */
...
//        ParameterChecker.checkParameter(parameters, "quantity", BigDecimal.class);
//        ParameterChecker.checkParameter(parameters, "price", BigDecimal.class);

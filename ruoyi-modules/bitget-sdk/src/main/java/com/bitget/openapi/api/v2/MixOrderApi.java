...
public interface MixOrderApi {
    ...
    Call<ResponseResult> followerClosePositions(@Body Map<String, String> paramMap,@HeaderMap Map<String, String> headerMap);
    ...
    Call<ResponseResult> placePosTpslOrder(@Body HashMap<String, String> paramMap);
}

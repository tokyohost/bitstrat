...
public class MixAccountService {
    ...
    public ResponseResult allPosition(Map<String,String> paramMap,Map<String,String> headerMap) throws IOException {
        return ResponseUtils.handleResponse(mixAccountApi.allPosition(paramMap,headerMap).execute().body());
    }
    public ResponseResult historyPosition(Map<String,String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixAccountApi.historyPosition(paramMap).execute().body());
    }
}

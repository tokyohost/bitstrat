...
public class MarketCompareWebSocketServerInitializer extends ChannelInitializer<SocketChannel> {
    CompareNettyConfig nettyConfig;
    WebSocketHandlerMarketCompare webSocketHandler;
    HttpRequestHandler httpRequestHandler;
    public MarketCompareWebSocketServerInitializer(CompareNettyConfig config, WebSocketHandlerMarketCompare webSocketHandler, HttpRequestHandler httpRequestHandler) {

...
public class MixMarketService {
    ...
    public ResponseResult openInterest(HashMap<String, String> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixMarketApi.openInterest(paramMap).execute().body());
    }
}

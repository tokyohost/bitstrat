...
/**
 * 跨交易所套利任务对象 coins_cross_exchange_arbitrage_task
 *
 * @author Lion Li
 * @date 2025-04-19
 */
...
@TableName("coins_cross_exchange_arbitrage_task")
public class CoinsCrossExchangeArbitrageTask extends TenantEntity {

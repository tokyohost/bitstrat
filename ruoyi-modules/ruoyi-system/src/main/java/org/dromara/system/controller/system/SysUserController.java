...
public class SysUserController extends BaseController {
     ...
     * 后台充值
     */
    @SaCheckPermission("system:user:addBalance")
    @Log(title = "后台充值", businessType = BusinessType.INSERT)
    @PostMapping("/addBalance")
    public R<Void> addBalance(@Validated @RequestBody SysUserAddBalanceBo balanceBo) {
        int i = userService.updateUserBalance(balanceBo);
        SpringUtils.getApplicationContext().publishEvent(balanceBo);
        return toAjax(i);
    }

...
public class ApiClient {
     ...
     * noauth clinet
     * @param baseUrl url
     * @param timeout 超时时间  sec
     */
    public ApiClient(String baseUrl, Long timeout) {
        this.parameter = new ClientParameter();
        this.parameter.setBaseUrl(baseUrl);
        this.parameter.setTimeout(timeout);
        retrofit = new Retrofit.Builder()
                .baseUrl(parameter.getBaseUrl())
                .addConverterFactory(GsonConverterFactory.create())
    ...
    private OkHttpClient httpClientNoAuth() {
        return new OkHttpClient.Builder()
                .addInterceptor(new HttpStatusInterceptor())
                .connectTimeout(parameter.getTimeout(), TimeUnit.SECONDS)
                .readTimeout(parameter.getTimeout(), TimeUnit.SECONDS)
        ...
        public Response intercept(Chain chain) {
            ...
            try {
                ...
                Request.Builder requestBuilder = original.newBuilder()
                        ...
                        .url(url);
                if(clientParameter.getPaptrading() != null){
                    requestBuilder.addHeader("paptrading", "1");
                }

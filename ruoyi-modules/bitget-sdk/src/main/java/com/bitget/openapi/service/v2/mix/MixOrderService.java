...
public class MixOrderService {
    ...
    public ResponseResult modifyTpslOrder(Map<String, String> paramMap) throws IOException {
    ...
    public ResponseResult followerClosePositions(Map<String, String> paramMap,Map<String,String> headerMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.followerClosePositions(paramMap,headerMap).execute().body());
    }
    ...
    public ResponseResult placePosTpslOrder(HashMap<String, String> paramMap) throws IOException {
